...
class SortOrder: FormViewController {
    ...
    override func viewDidLoad() {
        ...
        form +++ Section(footer: "Set the order to be used when displaying books in each of the three sections: To Read, Reading and Finished.")

        +++ SelectableSection<ListCheckRow<TableSortOrder>>(header: "To Read", footer: "Title sorts the books alphabetically; Author sorts the books alphabetically by the first author's surname; Custom allows the books to be sorted manually: tap Edit and drag to reorder the books.", selectionType: .singleSelection(enableDeselection: false))
